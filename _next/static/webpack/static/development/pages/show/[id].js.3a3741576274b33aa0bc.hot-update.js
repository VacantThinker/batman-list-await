...
var Post = function Post(props) {
  ...
  console.log(id);
  var show = shows.get(id);
  console.log(show); // const show = shows.find(value => value["id"] == id)
...
//
//   // const show = shows.find(value => value.id === id)
//
//   return { show }
// }
...
//# sourceMappingURL=[id].js.3a3741576274b33aa0bc.hot-update.js.map